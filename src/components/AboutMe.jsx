...
import CV from "../lib/Diego_Cabrera_CV1.pdf";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href={CV} download="Diego_Cabrera_CV1.pdf" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">
                                {" "}
                                Download CV
                            </a>
                        </div>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground"> 
                                        Building responsive and user-friendly websites using modern technologies like WordPress, Angular, React and Vue.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground"> 
                                        Creating visually appealing and user-friendly interfaces for web applications.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground"> 
                                        Oversee projects from inception to completion, ensuring on-time and on-budget delivery, applying knowledge of agile methodologies such as Scrum.
                                    </p>
                                </div>
                            </div>
                        </div>
