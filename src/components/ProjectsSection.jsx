...
const projects = [
  {
    ...
    description:
      "A responsive corporate website developed with WordPress, HTML, Javascript, and CSS for inPERU, a Peruvian organization that promotes investment and financial markets internationally.",
  ...
  },
  {
    ...
    description:
      "An e-commerce website built with HTML, CSS, Javascript, and WordPress featuring a clean catalog layout and product listings with categories like beauty, wellness, technology, and home items.",
  ...
  {
    id: 5,
    title: "PasajeTrak App",
    description:
      "PasajeTrak is an Android app for tracking fares and expenses, built with Jetpack Compose and Supabase (authentication and cloud storage). It supports email authentication, password recovery, and section-based navigation: home (totals and recent activity), filterable history, entry forms, monthly statistics with charts, and user profile management. It uses MVVM architecture, persistent preferences, connectivity-aware UI, and periodic reminders to encourage expense logging.",
    image: "/projects/project5.png",
    tags: ["Android", "Kotlin", "Jetpack Compose", "Supabase"],
    link: "https://pasajetrak.netlify.app/",
  },
];
  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      ...
      <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto px-4">
        This section showcases a selection of web and software projects that
        demonstrate my ability to design, develop, and deploy modern digital
        solutions. Each project reflects my experience working with different
        technologies, frameworks, and design approaches to build functional,
